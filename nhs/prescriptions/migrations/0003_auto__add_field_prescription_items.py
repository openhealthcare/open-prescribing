...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Prescription.items'
        db.add_column(u'prescriptions_prescription', 'items',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Prescription.items'
        db.delete_column(u'prescriptions_prescription', 'items')
    ...
    models = {
        ...
        u'prescriptions.group': {
            'Meta': {'object_name': 'Group'},
            'drugs': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['prescriptions.Product']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
        u'prescriptions.prescription': {
            'Meta': {'object_name': 'Prescription'},
            'actual_cost': ('django.db.models.fields.FloatField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'items': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['prescriptions.Product']"}),
            'quantity': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        u'prescriptions.product': {
