...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'subs_analysis')

        # Adding model 'PinnedAnalysis'
        db.create_table(u'subs_pinnedanalysis', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('frag', self.gf('django.db.models.fields.CharField')(max_length=400)),
        ))
        db.send_create_signal(u'subs', ['PinnedAnalysis'])


    def backwards(self, orm):
        # Adding model 'Analysis'
        db.create_table(u'subs_analysis', (
            ('frag', self.gf('django.db.models.fields.CharField')(max_length=400)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'subs', ['Analysis'])

        # Deleting model 'PinnedAnalysis'
        db.delete_table(u'subs_pinnedanalysis')
    ...
    models = {
        ...
        u'subs.ccgsub': {
            'Meta': {'object_name': 'CCGSub'},
            'ccg': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ccgs.CCG']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'subs.pinnedanalysis': {
            'Meta': {'object_name': 'PinnedAnalysis'},
            'frag': ('django.db.models.fields.CharField', [], {'max_length': '400'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'subs.practicesub': {
            'Meta': {'object_name': 'PracticeSub'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
