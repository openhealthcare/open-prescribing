...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'subs_practicesub', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('practice', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['practices.Practice'])),
        ))
        db.send_create_signal(u'subs', ['PracticeSub'])

        # Adding model 'CCGSub'
        db.create_table(u'subs_ccgsub', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('ccg', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ccgs.CCG'])),
        ))
        db.send_create_signal(u'subs', ['CCGSub'])


    def backwards(self, orm):
        # Deleting model 'PracticeSub'
        db.delete_table(u'subs_practicesub')

        # Deleting model 'CCGSub'
        db.delete_table(u'subs_ccgsub')
