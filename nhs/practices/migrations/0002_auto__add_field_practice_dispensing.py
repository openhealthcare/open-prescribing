...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Practice.dispensing'
        db.add_column('practices_practice', 'dispensing',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Practice.dispensing'
        db.delete_column('practices_practice', 'dispensing')
