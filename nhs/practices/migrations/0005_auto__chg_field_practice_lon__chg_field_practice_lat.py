...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Practice.lon'
        db.alter_column(u'practices_practice', 'lon', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Practice.lat'
        db.alter_column(u'practices_practice', 'lat', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'Practice.lon'
        db.alter_column(u'practices_practice', 'lon', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Practice.lat'
        db.alter_column(u'practices_practice', 'lat', self.gf('django.db.models.fields.IntegerField')(null=True))
