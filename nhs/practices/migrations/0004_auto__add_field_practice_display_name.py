...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Practice.display_name'
        db.add_column(u'practices_practice', 'display_name',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Practice.display_name'
        db.delete_column(u'practices_practice', 'display_name')
