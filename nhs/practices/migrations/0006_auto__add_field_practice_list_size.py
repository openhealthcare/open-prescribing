...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Practice.list_size'
        db.add_column(u'practices_practice', 'list_size',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Practice.list_size'
        db.delete_column(u'practices_practice', 'list_size')
    ...
    models = {
        ...
        u'practices.practice': {
            ...
            'list_size': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
